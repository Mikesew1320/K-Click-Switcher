...
print_modname() {                            
  ...
  ui_print "                 NOTICE! "
  ui_print " "
  ui_print " K-CLICK SWITCHER NEEDS AT LEAST MAGISK 18+! "
  ui_print " "
  ui_print " *********************************************************** "
  ui_print " "
  ui_print " DON'T FORGET TO GIVE All THE CREDIT TO THE OFFICIAL "
  ui_print " CREATOR OF THE SOUND FILES PROVIDED IN THE MODULE AND THE "
  ui_print " PERSONS WHO PROVIDED THEM FOR ME TO USE! "
  ui_print " "
  ui_print " *********************************************************** "
  ui_print " "
